...
import { createInstructor } from "../../api/oracleInstructorsApi";
import useToast from "../../hooks/useToast";

export default function AdminInstructorsCreate() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      addToast({ title: "Created", message: "Instructor and login account created successfully.", variant: "success" });
  ...
  return (
    <div>
      ...
      <h2 className="text-2xl font-bold text-slate-800">Add instructor</h2>
      <p className="mt-2 text-slate-600">Create a new instructor record in Oracle.</p>
      ...
      <form onSubmit={handleSubmit} className="mt-6 max-w-xl space-y-4">
        ...
        <div className="rounded-lg border border-slate-200 bg-slate-50 p-4">
          ...
          <p className="mt-1 text-xs text-slate-600">Create linked login credentials for this instructor.</p>
