...
const MONGODB_URI = process.env.MONGODB_URI || 'mongodb://127.0.0.1:27017/lms_db';
...
const forumPosts = [
  {
    ...
    content: 'I understand removing repeating groups, but I still get confused when deciding whether a dependency is partial or transitive. Does anyone have a simple way to check it?',
    ...
    replies: [
      {
        student_id: 6,
        content: 'A good shortcut is to first identify the candidate key. If a non-key attribute depends on only part of a composite key, that is 2NF trouble. If it depends on another non-key attribute, that is 3NF trouble.',
        created_at: new Date('2025-10-14T10:05:00Z'),
      },
      {
        student_id: 12,
        content: 'Try making tiny examples with order_id and product_id. It clicked for me once I drew the functional dependencies.',
  ...
  },
  {
    ...
    content: 'For the bootcamp project, are you separating routes, controllers, and services from the start or only after the API grows?',
    ...
    replies: [
      {
        student_id: 2,
        content: 'I split them early. It feels like more files at first, but validation and testing get much easier.',
  ...
  },
  {
    ...
    content: 'I found a public sales dataset with around 12k rows. Is that enough to show meaningful cleaning steps and visual analysis?',
  ...
  },
  {
    ...
    content: 'I know both are for permissions, but when would you create a role instead of assigning policies directly to a user?',
    tags: ['aws', 'iam', 'cloud'],
    ...
    replies: [
      {
        student_id: 3,
        content: 'Roles are great for temporary access and services. Users are better for long-term identities.',
  ...
  },
  {
    ...
    content: 'Our group keeps polishing visuals too early. Should we stay in low fidelity longer before moving to Figma details?',
    ...
    replies: [
      {
        student_id: 4,
        content: 'Stay low fidelity until the flow is stable. Otherwise you spend time polishing screens that might be removed.',
  ...
  },
  {
    ...
    content: 'Do you usually catch NO_DATA_FOUND separately and let everything else fall through to a generic handler, or do you define custom exceptions for most business rules?',
    ...
    replies: [
      {
        student_id: 1,
        content: 'For business rules I like raise_application_error with specific codes. It makes the API layer much cleaner.',
...
const announcements = [
  {
    ...
    message: 'We will run an extra live workshop on normalization problems this Friday at 6.30 PM. Please review the sample dependency sheet before joining.',
  ...
  },
  {
    ...
    message: 'The mini project brief is now available. Build a REST API with at least three resources and submit your repository link by next week.',
  ...
  },
  {
    ...
    message: 'Before starting the cleaning assignment, post your chosen dataset in the forum so we can confirm it is appropriate.',
    target_group: 'module_students',
  ...
  },
  {
    ...
    message: 'Your sandbox credentials were sent to your student email. Contact support if you cannot access the lab environment.',
    target_group: 'course_students',
  ...
  },
  {
    ...
    message: 'Bring your low-fidelity and high-fidelity prototype versions. We will compare design decisions and feedback quality.',
    target_group: 'module_students',
...
const reviews = [
  {
    ...
    course_id: 1,
    rating: 5,
    review_text: 'Very clear explanations and the assignments felt practical instead of repetitive.',
  ...
  },
  {
    ...
    course_id: 3,
    rating: 4,
    review_text: 'Good balance between Python basics and real analytics tasks. I wanted a bit more dashboard practice.',
  ...
  },
  {
    ...
    course_id: 2,
    rating: 5,
    review_text: 'The project-based style kept me engaged and helped me connect backend and frontend concepts well.',
  ...
  },
  {
    ...
    course_id: 4,
    rating: 4,
    review_text: 'Solid introduction to cloud services and deployment. Labs were the best part.',
  ...
  },
  {
    ...
    course_id: 6,
    rating: 5,
    review_text: 'Excellent examples and critique sessions. It felt close to a real product design workflow.',
  ...
  },
  {
    ...
    course_id: 7,
    rating: 5,
    review_text: 'One of the strongest technical courses in the platform. The PL SQL coverage was especially useful.',
